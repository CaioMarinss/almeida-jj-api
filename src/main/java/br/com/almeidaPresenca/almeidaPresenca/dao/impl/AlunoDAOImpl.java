...
public class AlunoDAOImpl implements AlunoDAO {
    ...
    public AlunoVO insertAluno(AlunoVO alunoVO) {
        ...
        namedJdbcTemplate.update(sql.toString(), new MapSqlParameterSource(params), keyHolder, new String[]{"ID_ALUNO"});
    ...
    public AlunoVO updateAluno(Integer idAlunoAtual, AlunoVO alunoNovoVO) {
        ...
        sql.append("SET NOME = :NOME, CPF = :CPF, EMAIL = :EMAIL, SENHA = :SENHA, ID_GRADUACAO = :ID_GRADUACAO, ");
        sql.append(" SITUACAO = :SITUACAO, IC_ADMINISTRADOR = :IC_ADMINISTRADOR, DT_PAGAMENTO = :DT_PAGAMENTO,  ");
        sql.append(" ID_PLANO = :ID_PLANO, DT_EXPIRACAO_PLANO = :DT_EXPIRACAO_PLANO                             ");
